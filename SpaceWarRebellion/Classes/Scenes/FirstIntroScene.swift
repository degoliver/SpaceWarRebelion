...
class FirstIntroScene: CCScene {
    ...
    override init() {
        ...
        let string : String = "uma galáxia distante, forças alienígenas planejam ameaçar a terra."
    ...
    func createSceneObjects(){
        ...
        let boss: CCSprite = CCSprite(imageNamed: "firstIntro.png")
    ...
    override func touchBegan(touch: UITouch!, withEvent event: UIEvent!) {
        StateMachine.sharedInstance.changeScene(StateMachineScenes.SecondIntroScene, isFade: true)
    }
